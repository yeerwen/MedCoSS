...
class Unified_Model(nn.Module):
    def __init__(self, input_size_3D=(256, 256, 256), input_size_2D=(512, 512), patch_size=16, global_pooling=True, num_classes=3, pre_trained=False, pre_trained_weight=None):
