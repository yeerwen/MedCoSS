...
class Unified_Model(nn.Module):
    def __init__(self, now_2D_input_size, input_size_3D=(256, 256, 256), input_size_2D=(512, 512), in_chans=1, patch_size=16, num_classes=2, pre_trained=False, pre_trained_weight=None, model_name=None):
        ...
        if pre_trained:
            print("load parameters from ", pre_trained_weight, "model name", model_name)
    ...
    def forward(self, data, prompt=False):
        ori_imgs = data["data"]
