...
from dataloader import LAseg_Dataset, my_collate
import torch.backends.cudnn as cudnn
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        # print(os.getcwd())
        shutil.copytree("Downstream/Dim_3/LASeg", os.path.join(args.snapshot_dir, "code"))
        ...
        trainloader, train_sampler = engine.get_train_loader(
            LAseg_Dataset(args.data_dir, args.train_list, max_iters=args.itrs_each_epoch * args.batch_size,
