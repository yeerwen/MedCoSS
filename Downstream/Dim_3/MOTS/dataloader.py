...
class MOTS_Dataset_train(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(64, 192, 192), mean=(128, 128, 128), scale=True,
        ...
        for item in self.img_ids:
            ...
            img_gt_file = osp.join(preprocessed_data_path, 'Task100_MOTS/nnUNetData_plans_v2.1_stage1', img_identifier + '.npz')
            with open(os.path.join(preprocessed_data_path, 'Task100_MOTS/nnUNetData_plans_v2.1_stage1', img_identifier + '.pkl'), 'rb') as f:
...
class MOTS_Dataset_test(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(64, 192, 192), mean=(128, 128, 128), scale=True,
