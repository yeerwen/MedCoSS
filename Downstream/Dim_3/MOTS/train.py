...
from dataloader import MOTS_Dataset_train, my_collate
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        # print(os.getcwd())
        shutil.copytree("Downstream/Dim_3/MOTS", os.path.join(args.snapshot_dir, "code"))
        ...
        trainloader, train_sampler = engine.get_train_loader(
            MOTS_Dataset_train(args.data_dir, args.train_list, max_iters=args.itrs_each_epoch * args.batch_size,
