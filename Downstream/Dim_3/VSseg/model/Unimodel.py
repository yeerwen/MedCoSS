...
class Unified_Model(nn.Module):
    def __init__(self, now_3D_input_size,  input_size_3D=(256, 256, 256), input_size_2D=(512, 512), in_chans=1, patch_size=16, num_classes=2, pre_trained=False, pre_trained_weight=None):
        ...
        self.out = UnetOutBlock(spatial_dims=3, in_channels=feature_size, out_channels=num_classes)  # type: ignore
