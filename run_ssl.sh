...
--data_path_2D_xray "/data1/ywye/contiual_pretraining/2D/MIMIC-CXR-2.0-JPG/" \
--output_dir=$output_dir \
--log_dir=$output_dir \
--num_center 0.01 \
--buffer_ratio 0.05 \
...
--data_path_1D_text "/data/userdisk0/ywye/Pretrained_dataset/1D/2019.MIMIC-CXR-JPG/2.0.0/" \
--data_path_2D_xray "/data1/ywye/contiual_pretraining/2D/MIMIC-CXR-2.0-JPG/" \
--data_path_3D_CT "/data1/ywye/contiual_pretraining/3D/DeepLesion/" \
--output_dir=$output_dir \
--log_dir=$output_dir \
--num_center 0.01 \
--buffer_ratio 0.05 \
...
--data_path_2D_xray "/data1/ywye/contiual_pretraining/2D/MIMIC-CXR-2.0-JPG/" \
--data_path_3D_CT "/data1/ywye/contiual_pretraining/3D/DeepLesion/" \
--data_path_3D_MR "/data1/ywye/contiual_pretraining/3D/ADNI/" \
--output_dir=$output_dir \
--log_dir=$output_dir \
--num_center 0.01 \
--buffer_ratio 0.05 \
...
--data_path_3D_CT "/data1/ywye/contiual_pretraining/3D/DeepLesion/" \
--data_path_3D_MR "/data1/ywye/contiual_pretraining/3D/ADNI/" \
--data_path_2D_path "/data1/ywye/contiual_pretraining/2D/TCGA/" \
--output_dir=$output_dir \
--log_dir=$output_dir \
--num_center 0.01 \
--buffer_ratio 0.05 \
